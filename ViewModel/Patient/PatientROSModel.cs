...
namespace EndocPM.WebAPI
{
    public class PatientROSModel
    {
        ...
        public bool MusculoSkeletalNegative { get; set; }
        public bool MusculoSkeletalBackPain { get; set; }
        public bool MusculoSkeletalJointPain { get; set; }
        public bool MusculoSkeletalNeckPain { get; set; }
        public bool MusculoSkeletalMuscleWeakness { get; set; }
        ...
        public string ConstitutionalValue { get; set; }
        public string ENTValue { get; set; }
        public string RespiratoryValue { get; set; }
        public string GenitourinaryValue { get; set; }
        public string SkinValue { get; set; }
        public string psychiatricValue { get; set; }
        public string hematologicValue { get; set; }
        public string EyesValue { get; set; }
        public string CardiovascularValue { get; set; }
        public string GastrointestinalValue { get; set; }
        public string MusculoskeletalValue { get; set; }
        public string NeurologicValue { get; set; }
        public string EndocrinologyValue { get; set; }
        public string ImmunologicValue { get; set; }
