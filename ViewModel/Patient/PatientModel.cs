...
namespace EndocPM.WebAPI
{
    public class PatientModel
    {
        ...
        public partial class CDSPatientModel
        {
            public int PatientID { get; set; }
        }

        public partial class CDSPatientCodes
        {
            public string CDSCodes { get; set; }
        }

        //public partial class PatientModel    //: IAddress, IPager
        //  {
        //public PatientModel()
        //{
        //    this.IsActive = true;
        ...
        public List<VitalSignModel> VitalSignModelss { get; set; }
        public List<PatientMedicationModel> PatientMedicationModelss { get; set; }

        public List<PatientAllergyModel> PatientAllergyModelss { get; set; }

        public List<PatientWorkHistoryModel> PatientWorkHistoryModelss { get; set; }

        public List<FamilyHealthHistoryModel> FamilyHealthHistoryModelss { get; set; }

        public List<PatientImmunizationModel> PatientImmunizationModels { get; set; }
        public List<PatientDiagnosticListModel> PatientDiagnosticListModels { get; set; }

        public List<PatientInsuranceModel> PatientInsuranceModels { get; set; }

        public List<PatientLabOrderTestModel> PatientLabOrderModels { get; set; }

        public List<PatientTobaccoAlcoholHistoryModel> GetPatientTobaccoAlcoholHistoryModels { get; set; }

        public List<PatientFamilyModel> GetPatientFamilyModels { get; set; }

        public List<SOAPNotesModel> SOAPNotes { get; set; }
